    ...
    public ResponseEntity<?> process(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            if (opc.equals("Imprimir")) {
                ...
                Collections.addAll(list, id_con);
            ...
            if (opc.equals("Imprimir1")) {
                ...
                for (String s : id_con) {
                    ...
                    String no_arhivo_or = plantillaContractualDAO.List_pl_con_x_id(alma[1]);
            ...
            if (opc.equals("Listar_contrato")) {
                ...
                List<Map<String, ?>> list = contratoDAO.List_contra_x_idcto_json(id);
                // out.print(list.get(0).toString());
                rpta.put("rpta", "1");
                rpta.put("lista", list);
            }
