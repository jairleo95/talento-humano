...
public class DgpDAO implements IDgpDAO {
    ...
    @Override
    public void insert(String ID_DGP, String FE_DESDE, String FE_HASTA, double CA_SUELDO, String DE_DIAS_TRABAJO, String ID_PUESTO, String ID_REQUERIMIENTO,
...
//                x.setEs_presupuestado(rs.getString("es_presupuestado"));//todo: to check
    ...
    @Override
    public void enableDGP(String IDDGP) {
    ...
    @Override
    public String getProcessDetail(String iddgp, String idrp, String iddep) {
