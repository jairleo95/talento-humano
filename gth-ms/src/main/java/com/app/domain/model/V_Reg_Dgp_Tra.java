...
public class V_Reg_Dgp_Tra {
    ...
    public String getId_tipo_plani() {
    ...
    public String getId_requerimient() {
        return id_requerimient;
    }

    public void setId_requerimient(String id_requerimient) {
    ...
    public String getIddgp() {
        return iddgp;
    }

    public void setIddgp(String iddgp) {
        this.iddgp = iddgp;
    }
