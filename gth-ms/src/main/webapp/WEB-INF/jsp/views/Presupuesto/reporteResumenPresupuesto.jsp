...
<html>
    <head>
        ...
        <title>Res�men de Presupuesto</title>
                    ...
                    <div class="panel-body">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row">
                            ...
                            <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-group col-md-3 col-xs-12" >
                                    <label class="">Condici�n laboral - Requerimiento :</label>
                            ...
                            <table  class="table table-striped table-hover table-responsive table_list_sol" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center">�rea</th>
                ...
                success: function (data) {
                    ...
                    table = $('.table_list_sol').DataTable({
                        "language": {
                            ...
                            "sEmptyTable": "Uy! No hemos encontrado ninguna informaci�n.",
