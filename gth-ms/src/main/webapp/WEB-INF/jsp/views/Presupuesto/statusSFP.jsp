                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3 col-xs-12" >
                                        <label class="">�rea :</label>
                                        <select class="form-control select_area" >
                                            <option value="" selected disabled>[Seleccione]</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-3 col-xs-12" >
                                        <label class="">Secci�n :</label>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table class="table table-hover table-striped  table-responsive tabla_detalle_sol" >
                                    ...
                                    <tr><td class="td">Comentario(Observaci�n):</td><td><label id="spobs">Cargando...</label></td></tr> 
    ...
    <script type="text/javascript">
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i]['PROCESADOR'] == null) {
                            data[i].PROCESADOR = 'A�n no Procesado';
                        }
        ...
        function loadModal(datos) {
            ...
            if (datos['OBSERVACION'] == null) {
                datos.OBSERVACION = 'A�n no Procesado';
            }
