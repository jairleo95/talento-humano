                            ...
                            <div class="panel-body" style="background:#eeeeee  ;">
                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <label>RELIGI�N</label><br>
                                            <select class="form-control" style="width:100%;margin-top: 1%;">
                                                <option selected disabled>Elegir Religi�n</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>SEXO</label><br>
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" style="width:100%;margin-top: 1%;">
                                            ...
                                            <option value="3" >Sin R�gimen Provisional(jubilado, cesante).</option>
                                            <option value="4" selected="">Fuera de Planilla</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label>SITUACI�N EDUCATIVA</label><br>
                                        <select class="form-control selSE" style="width:100%;margin-top: 1%;">
                                            <option selected disabled>Elegir situaci�n educativa</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label>A�O DE EGRESO</label><br>
                                        <input type="date" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label>CONDICI�N</label><br>
                                        <select class="form-control" style="width:100%;margin-top: 1%;">
                                            <option selected disabled>Elegir Condici�n</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="cselectores">
                                        <div class="col-md-6">
                                            ...
                                            <select onchange="listdepartamento(this.value)" class="form-control selDir" style="width:100%;margin-top: 1%;">
                                                <option value="" selected disabled>Elegir Direcci�n</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select onclick="listpuesto(this.value)" class="form-control selSeccion" style="width:100%;margin-top: 1%;">
                                                <option value="" selected disabled>Elegir Secci�n</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
    ...
    <script>
                            ...
                            function listdireccion() {
                                ...
                                $.post(url, data, function (objJson) {
                                    ...
                                    if (lista.length > 0) {
                                        var m = '';
                                        m += '<option value="" selected disabled>Elegir Direcci�n</option>';
                            ...
                            function listarea(dep) {
                                ...
                                $.post(url, data, function (objJson) {
                                    ...
                                    if (lista.length > 0) {
                                        var m = '';
                                        m += '<option value="" selected disabled>Elegir �rea</option>';
                                        for (var i = 0; i < lista.length; i++) {
                            ...
                            function listseducativa() {
                                ...
                                $.post(url, data, function (objJson) {
                                    ...
                                    if (lista.length > 0) {
                                        var m = '';
                                        m += '<option value="" selected disabled>Elegir situaci�n educativa</option>';
                                        for (var i = 0; i < lista.length; i++) {
                            ...
                            function createTable() { //funcion para crear tabla que tendra los datos generales
                                ...
                                t += '<th data-hide="secc">Sección</th>';
                                ...
                                t += '<th data-class="tip">Situaci�n Educativa</th>';
                                t += '<th data-class="tip">Estudio en Instituto</th>';
                                t += '<th data-class="tip">Regimen</th>';
                                t += '<th data-class="tip">Tipo de Instituci�n</th>';
                                t += '<th data-hide="pues">Instituci�n</th>';
                                t += '<th data-class="fec_nac">Carrera</th>';
                                t += '<th data-class="ed">A�o de Egreso</th>';
                                ...
                                t += '<th data-class="tip">Religi�n</th>';
                                t += '<th data-class="tip">Iglesia</th>';
                                t += '<th data-class="tip">Cargo</th>';
                                t += '<th data-class="tip">Autoridad</th>';
                                t += '<th data-class="tip">Condici�n Laboral</th>';
                                t += '<th data-class="tip">Remuneraci�n B�sica</th>';
                                t += '<th data-class="tip">Bono de Alimentos</th>';
                                t += '<th data-class="tip">Bonificaci�n por puesto</th>';
                                ...
                                t += '<th data-class="tip">Situaci�n Educativa</th>';
                                t += '<th data-class="tip">Cod. R�gimen</th>';
                                t += '<th data-class="tip">Desc. R�gimen</th>';
                                t += '<th data-class="tip">Cod. Instituci�n</th>';
