                            ...
                            <form    id="form-plazo" class="form_plazo smart-form"style="display:none" >
                                ...
                                <section>
                                    <label class="textarea"> 										
                                        <textarea rows="3" name="descripcion" placeholder="Descripci�n" required="" class="descripcion" ></textarea> 
                                    </label>
                                </section>
                                <div class="row ">
                                ...
                                <div class="row">
                                    <section class="col col-4">
                                        <label class="select" id="titu">
                                            Direcci�n :<select name="direccion" class="direccion"  >
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr >
                                        ...
                                        <td class="text-center semi-bold">Descripci�n</td>
