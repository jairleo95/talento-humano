...
<div id="main" role="main" style="margin-left: 0px;">
    ...
    <script src="js/businessLogic/coment/coment.js" type="text/javascript"></script>
    <!--================================================== -->
    ...
    <script src="js/businessLogic/Dgp/procesarRequerimiento.js" type="text/javascript"></script>
