...
<link href="css/businessLogic/Dgp/autorizarRequerimiento.css" rel="stylesheet" type="text/css"/>
    ...
    %>
    <body onload='exito("Procesado con exito!", "Usted ha realizado una autorizaci�n correctamente.");
    ...
    <body class="" onload="nobackbutton();">
                                    ...
                                    <ul id="widget-tab-1" class="nav nav-tabs pull-right">
                                        ...
                                        <li>
                                            <a data-toggle="tab" href="#hr2"> <i class="fa fa-lg fa-arrow-circle-o-up"></i>
                                                <span class="hidden-mobile hidden-tablet"> Carga acad�mica</span>
                                                ...
                                                <table id="dt_basic1" class="table table-striped table-bordered table-hover" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class='hasinput'  style='' >
                                                            <button   rel="tooltip" data-placement="left" data-original-title="Autorizar y Procesar c�digo aps"
                                                    ...
                                                    <tr data-hide="phone,tablet">
                                                        ...
                                                        <th data-hide="phone,tablet"><strong>Acci�n</strong></th>
                                                        <th>Mes</th>
                                                        ...
                                                        <th data-hide="phone,tablet"><strong>Descripci�n</strong></th>
                                                        <th  data-hide="phone,tablet">Fecha de Creaci�n</th>  
                                                        ...
                                                        <th><strong>�Contrato Subido?</strong></th>
                                                            ...
                                                            <%if (idrol.trim().equals("ROL-0009")) {%>
                                                        <th><strong>C�digo APS</strong></th>
                                                            <%}%>
                                                            <%if (idrol.trim().equals("ROL-0007") | idrol.trim().equals("ROL-0001")) {%>
                                                        <th><strong>C�digo Huella</strong></th>
                                                            <%}%>
                                                    </tr>
                                                    </thead>
        ...
        <div class="modal fade sendEmailsModal" tabindex="-1">
            ...
            Compartimos la siguiente informaci�n<br><br>
             - Bienestar para el trabajador<br>
             - Reglamento de Control de Asistencia<br>
             - Reglamento de trabajo<br>
             - Bolet�n Informativo - sistema pensionario<br>    
                                                        <br><br><br>Gracias,<br><strong>Ing. Iv�n Huam�n Fern�ndez</strong><br><br><small>�rea de Sistemas<br> Gerencia del Talento Humano<br>Universidad Peruana Uni�n<br><i class="fa fa-phone"> (+51) 989 059 491</i></small><br>		
                                        </textarea>	
                                    </div>
                                    <div class="inbox-info-bar">
                                        <div class="row">
