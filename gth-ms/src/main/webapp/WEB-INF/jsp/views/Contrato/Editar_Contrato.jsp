...
<%@page import="com.app.domain.model.V_Contrato_dgp"%>
...
<html>
    ...
    <body>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form action=contrato"  class="smart-form formEditawrContrato"  method="POST" >
                                <fieldset >
                                    ...
                                    <div class="row" >
                                        ...
                                        <section class="col col-3" id="titulo">
                                            <label class="select" id="titulo">Direcci�n:
                                        ...
                                        <section class="sec_sec col col-3" id="titulo">
                                            <label class="select" id="titulo">Secci�n:
                                        ...
                                        <section class="col col-3">
                                            <label class="select" id="titulo">Condici�n:
                                                <select name="CONDICION" class="input-group-sm" required="">
                                                    ...
                                                    <option value="5" <%if (a.getLi_condicion().trim().equals("5")) {%>selected=""<%}%>>Pr�ctica Profesional</option>
                                                    <option value="6" <%if (a.getLi_condicion().trim().equals("6")) {%>selected=""<%}%>>Pr�ctica Pre Profesionales</option>
                                                    ...
                                                    <option value="5">Pr�ctica Profesional</option>
                                                    <option value="6">Pr�ctica Pre Profesionales</option>
                                    ...
                                    <div class="row">
                                        <section class="col col-2">
                                            <label class="input" id="titulo">Remuneraci�n:
                                        ...
                                        <section class="col col-2" >
                                            <label class="input" id="titulo">Asignanci�n Familiar:
                                ...
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-2">
                                            <label class="select" id="titulo">Situaci�n Especial:
                                        ...
                                        <section class="col col-4">
                                            <label class="select" id="titulo">Tipo Contrataci�n:
                                        ...
                                        <section class="col col-4">
                                            <label class="input" id="titulo">Fecha de Suscripci�n: 
                                        ...
                                        <section class="col col-4">
                                            <label class="select" id="titulo">Remuneraci�n en Especie:
                                        ...
                                        <section class="col col-4">
                                            <label class="select" id="titulo">Regimen Laboral: 
                                                <select name="REGIMEN_LABORAL" class="input-group-sm" required="">
                                                    ...
                                                    <option value="2" <%if (a.getLi_regimen_laboral().trim().equals("2")) {%> selected=""<%}%> >P�blico</option>
                                                    <%} else {%>
                                                    <option value="1">Privado</option>
                                                    <option value="2" selected="">P�blico</option>
                                                    <%}%>
                                                </select>
                                            </label>
                                        </section>
                                ...
                                <fieldset>
                                    <section>
                                        <label class="label" id="titulo">Observaci�n:  </label>
        ...
        <script type="text/javascript" src="js/businessLogic/Contrato/editContrato.js" ></script>
