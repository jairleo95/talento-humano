    ...
    <body class="slideInDown fast animated"> 
                ...
                <div id="contenido">                
                    ...
                    <div class="col-md-12 advice hidden">
                        <div class="alert alert-danger alert-dismissible" role="alert" style="width: 50%;">
                            ...
                            <i class="glyphicon glyphicon-exclamation-sign"></i>   No se encontraron datos en la b�squeda
                        </div>
                    </div>
                    <div class="col-md-12">
        ...
        <script>
                                ...
                                function createTable() {
                                    ...
                                    t += '<th><center><h6 title="SECCION"><i class="glyphicon glyphicon-adjust"></i>   Secci�n</h6></center></th>';
                                    ...
                                    t += '<th><center><h6 title="FECHA_CREACION"><i class="glyphicon glyphicon-calendar"></i>   Fecha de Contrataci�n</h6></center></th>';
