                                                ...
                                                <div class="tab-content padding-10">
                                                    ...
                                                    <div class="tab-pane fade in active" id="iss1">
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr>
                                                                    <th><i class="fa  fa-align-left"> </i> Abreviaci�n</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr><td><code>[dep]</code></td><td>Departamento en donde se va a desenpe�ar</td></tr>
                                                                ...
                                                                <tr><td><code>[puesto]</code></td><td>Puesto que va a desempe�ar</td></tr>
                                                                <tr><td><code>[fe_suscripcion]</code></td><td>Fecha de suscripcion</td></tr>
                                                                <tr><td><code>[sueldo]</code></td><td>Sueldo b�sico del trabajador</td></tr>
                                                                ...
                                                                <tr><td><code>[cursos]</code></td><td>Cuesos que va ense�ar (en el caso que sea docente)</td></tr>
                                                                <tr><td><code>[funciones_pr]</code></td><td>Funciones primarias que va a desempe�ar en el puesto</td></tr>
                                                                <tr><td><code>[funciones_sec]</code></td><td>Funciones secundarias que va a desempe�ar en el puesto</td></tr>
...
<script type="text/javascript" src="js/businessLogic/Contrato/formato-plantilla-api.js"></script>
</html>
