...
<div id="main" role="main" style="margin-left: 0px;">
                                        ...
                                        <div id="bootstrap-wizard-1" class="col-sm-12">
                                            <div class="form-bootstrapWizard">
                                                <ul class="bootstrapWizard form-wizard">
                                                    ...
                                                    <li data-target="#step2">
                                                        <a href="#tab2" data-toggle="tab"> <span class="step">2</span> <span class="title">Aspecto Acad�mico</span> </a>
                                                    </li>
                                            ...
                                            <div class="tab-content">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select    name="A_EGRESO" class="form-control input-group-sm" required="" >
                                                                        <option value="">[A�o Egreso]</option>
                                                ...
                                                <div class="tab-pane" id="tab4">
                                                    ...
                                                    <h3><strong>Paso 5</strong> - Datos del c�nyugue</h3>
    ...
    <script src="js/businessLogic/Trabajador/regTrabajador.js" type="text/javascript"></script>
