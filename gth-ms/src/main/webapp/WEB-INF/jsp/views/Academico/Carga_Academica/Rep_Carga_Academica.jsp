    ...
    <div class="col-md-12">
        <div class="well">
            <div class="row">
                <div class="col-md-8">
                    <h1>
                        <span class="semi-bold">Reporte</span> <i class="ultra-light">Carga Acad�mica</i> (Docentes)
                        <sup class="badge bg-color-red bounceIn animated">v 2.0</sup> <br>
                        <small class="text-danger slideInRight fast animated"><strong>Inicio de contrataci�n</strong></small></h1>
                </div>
                <div class="col-md-4">
                    <br>
                    ...
                    <button type="button" class="btn btn-primary btn-lg btn-circle pull-right btnInitUpdateCAData" disabled="disabled" rel="tooltip" data-placement="top" data-original-title="Iniciar Actualizacion de Carga acad�mica"  >
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" 
                ...
                <header>
                    ...
                    <h2>Carga Acad�mica</h2>
                    <ul class="nav nav-tabs pull-right in" id="myTab"> 
                        <li class="active">
                            <a data-toggle="tab" href="#s1"><i class="fa fa-user"></i> <span class="hidden-mobile hidden-tablet">Usuarios RRHH</span></a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#s2"><i class="fa fa-users"></i> <span class="hidden-mobile hidden-tablet">Usuarios Acad�mico</span></a>
                        </li>
                    </ul>
                </header>
                        ...
                        <table   class="table table-striped table-bordered table-hover datatableCargaAcademica" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>Facultad</th>
                                    <th>Escuela</th>
                                    <th>Situaci�n Educativa</th>
                                    <th>Profesi�n Docente</th>
                                    <th>Condici�n</th>
                                    <th>Ciclo</th>
                                    <th>Inicio</th>
                                    <th>Cese</th>
