...
<html>
    ...
    <body class="smart-style-1 fixed-header fixed-footer mainBody"  onload="nobackbutton();
            ...
            <div class="logininfo">
                <div class="row">
                    <div class="avatar-user col-md-3">
                        ...
                        <a href="trabajador?opc=edit_perfil"  id="show-shortcut" >
                ...
                <ul>
                    ...
                    <li class="li-privilegio bounceInDown animated">
                        ...
                        <ul>
                            ...
                            %>
                            <li>
                                <a href="Vista/Dgp/Requerimiento.jsp?opc=Planilla"><i class="fa fa-lg fa-fw fa-file"></i> En Planilla</a>
                            </li>
                            <%}
                                if (id_rol.trim().equals("ROL-0011") | id_rol.trim().equals("ROL-0001")) {%>
                            <li>
                    ...
                    <li class="li-privilegio bounceInDown animated">
                        ...
                        <a href="<%=dp.getDi_url()%>" title="<%=dp.getNo_link()%>" data-value="<%=dp.getIc_link().trim()%>" class="link"  id="link"><i class="<%=dp.getIc_link().trim()%>"></i> <span class="menu-item-parent"><%=dp.getNo_link()%></span></a>
                            <%}
                                }
                                if (!id_rol.trim().equals("ROL-0013")) {
                    ...
                    <li class="li-privilegio bounceInDown animated">
                        ...
                        <ul>
                            <%if (gpres != null) {%>
                            <li>
                                <a href="<%=gpres.getDi_url()%>" ><i class="<%=gpres.getIc_link()%>"></i> <%=gpres.getNo_link()%></a>
                            </li>
                            <%}
                                if (rspres != null) {%>
                            <li>
                                <a href="<%=rspres.getDi_url()%>" ><i class="<%=rspres.getIc_link()%>"></i> <%=rspres.getNo_link()%></a>
                            </li>
                            <%}
                                if (spres != null) {%>
                            <li>
                                <a href="<%=spres.getDi_url()%>" ><i class="<%=spres.getIc_link()%>"></i> <%=spres.getNo_link()%></a>
                            </li>
                            <%}
                                if (resdetpres != null) {%>
                            <li>
                                <a href="<%=resdetpres.getDi_url()%>" ><i class="<%=resdetpres.getIc_link()%>"></i> <%=resdetpres.getNo_link()%></a>
                            </li>
                            <%}
                                if (respres != null) {%>
                            <li>
                                <a href="<%=respres.getDi_url()%>" ><i class="<%=respres.getIc_link()%>"></i> <%=respres.getNo_link()%></a>
                            </li>
                            <%}%>
                        </ul>
                    </li>
        ...
        <div id="main" role="main">
            ...
            <!-- END RIBBON -->
            <!-- MAIN CONTENT -->
            <div  id="content" class="newContent"></div>
            <div id="content2" class="oldContent" style="display:none">
        ...
        <div id="shortcut">
            <ul>
                ...
                <li>
                    <a href="Usuario?opc=Ver_Perfil&id=<%=(String) sesion.getAttribute("IDUSER")%>"  title="SS" class="jarvismetro-tile big-cubes selected bg-color-pinkDark"  > <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>Mi Perfil </span> </span> </a>
                </li>
            </ul>
        </div>
        <!-- END SHORTCUT AREA -->
        ...
        <!--Business Logic -->
        <script src="js/businessLogic/Principal.js" type="text/javascript"></script>
    </body>
