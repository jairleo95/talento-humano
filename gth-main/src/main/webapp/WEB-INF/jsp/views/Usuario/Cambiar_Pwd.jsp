                ...
                <section id="widget-grid" class="">
                    <div class="row">
                        <div class="well slideInDown fast animated">
                            <h1 class="text-center"><strong>Cambiar Contrase�a  </strong> <small>  </small></h1><br>
                            <form class="smart-form form_cambiar_clave" >
                                <div class="row">

                                    <div class="col col-lg-12">
                                        <section class="col col-sm-4">Contrase�a actual:
                                            <label class="input"> <i class="icon-append fa fa-lock"></i>
                                                <input type="password" name="password1" placeholder="Clave Actual"  required="">
                                                <b class="tooltip tooltip-bottom-right">Ingrese su contrase�a actual</b> </label>
                                        </section>
                                        <section class="col col-sm-4">Escribir nueva contrase�a:
                                            <label class="input"> <i class="icon-append fa fa-lock"></i>
                                                <input type="password" name="password2" placeholder="Clave Nueva" id="password" required="">
                                                <b class="tooltip tooltip-bottom-right">No olvides tu contrase�a</b> </label>
                                        </section>
                                        <section class="col col-sm-4">Confirmar Contrase�a:
                                            <label class="input"> <i class="icon-append fa fa-lock"></i>
            ...
            $(document).ready(function () {
                        ...
                        $.ajax({
                            ...
                            if (e == '0') {
                                $.smallBox({
                                    ...
                                    content: "<i class='fa fa-clock-o'></i> <i>Contrase�a actual incorrecta, intente de nuevo...</i>",
                                    color: "#C46A69",
                                ...
                                $.smallBox({
                                    ...
                                    content: "<i class='fa fa-clock-o'></i> <i>Se ha modificado la contrase�a correctamente...</i>",
                                    color: "#659265",
                ...
                $(".form_cambiar_clave").validate({
                    ...
                    messages: {
                        ...
                        password: {
                            required: 'Ingrese una contrase�a nueva'
                        },
                        passwordConfirm: {
                            required: 'Please enter your password one more time',
                            equalTo: 'La contrase�as no son iguales'
                        }
                    },
