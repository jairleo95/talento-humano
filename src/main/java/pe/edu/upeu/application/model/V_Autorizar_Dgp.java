...
public class V_Autorizar_Dgp {
    ...
    public String getMes_plazo() {
        return mes_plazo;
    }

    public void setMes_plazo(String mes_plazo) {
        this.mes_plazo = mes_plazo;
    }

    public int getVal_dgp_cotrato() {
        return val_dgp_cotrato;
    }

    public void setVal_dgp_cotrato(int val_dgp_cotrato) {
        this.val_dgp_cotrato = val_dgp_cotrato;
    }
    ...
    public V_Autorizar_Dgp(String id_trabajador, String no_trabajador, String ap_paterno, String ap_materno,
            ...
            String li_motivo, String es_mfl, String di_correo_personal, String di_correo_inst, String fe_autorizacion, int val_contrato_adjunto, int val_dgp_cotrato,String mes_plazo) {
