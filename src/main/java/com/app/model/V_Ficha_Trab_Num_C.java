...
public class V_Ficha_Trab_Num_C {
    ...
    private String co_universitario;
    private String vi_contrato; 
    private String es_diezmo; 

    public String getEs_diezmo() {
        return es_diezmo;
    }

    public void setEs_diezmo(String es_diezmo) {
        this.es_diezmo = es_diezmo;
    }
            
    public V_Ficha_Trab_Num_C(String id_trabajador, String ap_paterno, String ap_materno, String no_trabajador, String ti_doc, String nu_doc, String es_civil, String fe_nac,
            String no_nacionalidad, String no_departamento, String no_provincia, String no_distrito, String te_trabajador, String cl_tra, String di_correo_personal,
            String di_correo_inst, String co_sistema_pensionario, String id_situacion_educativa, String li_reg_inst_educativa, String es_inst_educ_peru, String cm_otros_estudios,
            String es_sexo, String li_grupo_sanguineo, String de_referencia, String li_religion, String no_iglesia, String de_cargo, String li_autoridad, String no_ap_autoridad, 
            String cl_autoridad, String id_no_afp, String es_afiliado_essalud, String li_tipo_trabajador, String ca_tipo_hora_pago_refeerencial, String es_factor_rh,
            String li_di_dom_a_d1, String di_dom_a_d2, String li_di_dom_a_d3, String di_dom_a_d4, String li_di_dom_a_d5, String di_dom_a_d6, String di_dom_a_ref, 
            String di_dom_a_distrito, String li_di_dom_leg_d1, String di_dom_leg_d2, String li_di_dom_leg_d3, String di_dom_leg_d4, String li_di_dom_leg_d5, String di_dom_leg_d6,
            String di_dom_leg_distrito, String ca_ing_qta_cat_empresa, String ca_ing_qta_cat_ruc, String ca_ing_qta_cat_otras_empresas, String cm_observaciones, String us_creacion, 
            String fe_creacion, String us_modif, String fe_modif, String ip_usuario, String id_usuario_creacion, String id_universidad_carrera, String id_nacionalidad, String distrito_nac, 
            String no_s_educativa, String ap_nombres_madre, String ap_nombres_padre, String es_trabaja_upeu_c, String ap_nombres_c, String fe_nac_c, String id_tipo_doc_c, String nu_doc_c, 
            String li_inscripcion_vig_essalud_c, String id_conyugue, String no_carrera, String no_universidad, String ar_foto, String de_foto, String id_foto, String no_ar_foto, String ta_ar_foto,
            String es_proceso , String de_anno_egreso, String id_carrera, String id_distrito, String id_provincia, String id_departamento, String id_di_dom_a_distrito, 
            String id_di_dom_leg_distrito, String co_universitario , String vi_contrato,String es_diezmo) {
        ...
        this.co_universitario = co_universitario; 
        this.vi_contrato = vi_contrato;
        this.es_diezmo= es_diezmo;
        
    }

    public String getVi_contrato() {
        return vi_contrato;
    }

    public void setVi_contrato(String vi_contrato) {
        this.vi_contrato = vi_contrato;
    }

    
    public String getEs_proceso() {
        return es_proceso;
    }

    public void setEs_proceso(String es_proceso) {
        this.es_proceso = es_proceso;
    }
    ...
    public void setId_di_dom_leg_distrito(String id_di_dom_leg_distrito) {
     ...
     public String getCo_universitario() {
        return co_universitario;
    }

    public void setCo_universitario(String co_universitario) {
        this.co_universitario = co_universitario;
    }
