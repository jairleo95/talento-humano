...
private String ar_foto;
    ...
    public String toString() {
        return "V_Usuario{" +
                ...
                ", cl_tra='" + cl_tra + '\'' +
                ", te_trabajador='" + te_trabajador + '\'' +
                ", li_di_dom_a_d1='" + li_di_dom_a_d1 + '\'' +
                ", di_dom_a_d2='" + di_dom_a_d2 + '\'' +
                ", li_di_dom_a_d3='" + li_di_dom_a_d3 + '\'' +
                ", di_dom_a_d4='" + di_dom_a_d4 + '\'' +
                ", li_di_dom_a_d5='" + li_di_dom_a_d5 + '\'' +
                ", di_dom_a_d6='" + di_dom_a_d6 + '\'' +
                ", di_dom_a_ref='" + di_dom_a_ref + '\'' +
                ", di_correo_personal='" + di_correo_personal + '\'' +
                ", di_correo_inst='" + di_correo_inst + '\'' +
                ", li_religion='" + li_religion + '\'' +
                ", no_iglesia='" + no_iglesia + '\'' +
                ", de_cargo='" + de_cargo + '\'' +
                ", li_autoridad='" + li_autoridad + '\'' +
                ", no_ap_autoridad='" + no_ap_autoridad + '\'' +
                ", cl_autoridad='" + cl_autoridad + '\'' +
                ", id_distrito_ub='" + id_distrito_ub + '\'' +
                ", id_provincia_ub='" + id_provincia_ub + '\'' +
                ", id_departamento_ub='" + id_departamento_ub + '\'' +
                ", no_departamento_ub='" + no_departamento_ub + '\'' +
                ", no_provincia_ub='" + no_provincia_ub + '\'' +
                ", no_distrito_ub='" + no_distrito_ub + '\'' +
                ", ar_foto='" + ar_foto + '\'' +
                '}';
    }
}
