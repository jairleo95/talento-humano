                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel"><span class="btn-label"><i class="fa fa-envelope"></i></span> <strong>Solicitud de ampliaci�n de Presupuesto</strong></h4>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table table-hover table-striped  table-responsive tabla_detalle_sol" >
                                    ...
                                    <tr><td class="td">�rea:</td><td><label id="spare">Cargando...</label></td></tr>   
                                    ...
                                    <tr><td class="td">Motivo(Justificaci�n):</td><td><label id="spcom">Cargando...</label></td></tr> 
                                </table>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="well well-sm well-primary">
                                            <div class="form-group">
                                                <textarea id="spobs" class="form-control" placeholder="Comentario (Observaci�n)" rows="5" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function loadModal(datos) {
            ...
            $.ajax(pres", {
                ...
                success: function (obj) {
                    ...
                    info += '<strong>Situaci�n Actual: Por Departamento</strong><br/>';
                    ...
                    info += '<strong>Situaci�n Actual: Por �rea</strong><br/>';
            ...
            info += '<strong>Situaci�n Actual: Por Puesto</strong><br/>';
        ...
        function authPres(idsfp, est, ntra, idpp) {
            ...
            if (obs !== "") {
                        ...
                        $.ajax(url, {
                            ...
                            success: function (obj) {
                                if (obj.rpta === 1) {
                                    ...
                                    $.smallBox({
                                        title: "�Oh no!",
                                        content: "<i>Nuestro gatito encargado de enviar solicitudes se qued� dormido. Ya lo estamos despertando, int�ntalo de nuevo m�s tarde ;)</i><img src='../../img/sleeping_cat.jpg' alt='Sleeping Cat' >",
                                        color: "#FF7A7A",
                ...
                $.smallBox({
                    title: "�Espere!",
                    content: "<i>Es necesario que usted ingrese alg�n comentario u observaci�n antes de procesar esta solicitud.</i>",
                    color: "#FFBF7A",
                    iconSmall: "fa fa-close fa-2x fadeInRight animated",
                    timeout: 4000
                });
