                        ...
                        <table id="datatable_tabletools" class="table table-striped table-bordered table-hover table-responsive" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>N�mero de documento del trabajador</th>
                                    <th>Pa�s emisor del documento</th>
                                    <th>Formaci�n Superior Completa</th>
                                    <th>CODIGO DE SITUACION EDUCATIVA</th>
                                    <th>Indicador de educaci�n completa en una Instituci�n Educativa del Per�</th>
                                    <th>C�digo de la Instituci�n Educativa</th>
                                    <th>C�digo de la Carrera</th>
                                    <th>A�o de Egreso</th>
                                </tr>
                            </thead>
                            <tbody id="Li_cump">
