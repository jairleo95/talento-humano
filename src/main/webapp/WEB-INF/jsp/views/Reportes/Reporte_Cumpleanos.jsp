...
<html>
            ...
            <center>
                ...
                <div id="contenido" >
                    ...
                    <div class="form-group" >
                        ...
                        <input type="text"  class="form-control sec" placeholder="Ingrese su SECCI�N" length="45" style="width: 150px" id="des"/>
                    </div>
                    <div class="form-group" >
                    ...
                    <div class="form-group" >
                        ...
                        <input type="text"  class="form-control num" placeholder="N� Documento" length="45" style="width: 120px" id="des"/>
                    </div>
                    <div>
    ...
    <script>
        ...
        function listar_cumplea�os() {
            ...
            var d = $("#Li_cump");
            var texto = '';
            $.post(reporte", "opc=reporte_cumplea�os&mes=" + a + "&dia=" + b + "&aps=" + ap + "&departamento=" + de + "&area=" + ar + "&seccion=" + se + "&puesto=" + pu + "&fecha=" + fe + "&edad=" + eda + "&paterno=" + apt + "&materno=" + ma + "&nombre=" + "&tipo=" + ti + "&num=" + nu, function (objJson) {
