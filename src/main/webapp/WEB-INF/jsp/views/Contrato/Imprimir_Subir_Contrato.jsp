    ...
    <body>
        ...
        <div>
            ...
            <table class="table table-hover table-striped  table-responsive">
                ...
                <tr><td class="text-info table-bordered"><strong>Direcci�n:</strong></td><td colspan="6" class="table-bordered" ><p><%=n.getNo_direccion()%> </p></td></tr>
                ...
                <tr><td class="text-info table-bordered"><strong>Secci�n:</strong></td><td colspan="6" class="table-bordered" ><p><%=n.getNo_seccion()%> </p></td></tr>
