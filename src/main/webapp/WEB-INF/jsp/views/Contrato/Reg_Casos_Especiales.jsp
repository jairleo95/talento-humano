                                            ...
                                            <div class="smart-form" >
                                                ...
                                                <fieldset id="fila-agregar">
                                                    ...
                                                    <div class="row" >
                                                        ...
                                                        <section class="col col-2" id="titu">
                                                            <label class="select" id="titu">Direcci�n:
                                                        ...
                                                        <section class="col col-3" id="titulo">
                                                            <label class="select" id="titu">Secci�n:
                                                    ...
                                                    <div class="row">
                                                        <section class="col col-2">
                                                            <label class="input" id="titu">Remuneraci�n:
                                                        ...
                                                        <section class="col col-2" >
                                                            ...
                                                            <label class="input" id="titu">Asignanci�n Familiar:
                                                    ...
                                                    <div class="row centro-costo_1" >
                                                        <!--<code class="ver"></code>-->
                                                        <section class="col col-3">
                                                            <label id="titu" class="centro-costo_1" >Centro de Costo N� 1:</label>
                                                            <label class="select" id="titu">Direcci�n :
                                                ...
                                                <fieldset>
                                                    <div class="row">
                                                        ...
                                                        <section class="col col-4">
                                                            <label class="select" id="titu">Tipo Contrataci�n:
                                                                <select name="REG_LAB_MINTRA" class="input-group-sm" >
                                                                    <option value="">[Seleccione]</option>
                                                        ...
                                                        <section class="col col-4">
                                                            ...
                                                            <label class="input" id="titu">Fecha de Suscripci�n: 
                                                        ...
                                                        <section class="col col-4">
                                                            <label class="select" id="titu">Remuneraci�n en Especie:
                                                ...
                                                <fieldset>
                                                    <div class="">
                                                        <section class="col col-12">
                                                            <label class="textarea" id="titu">Observaci�n:  </label>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="input-desp">
                                                        ...
                                                        <table id="show_sab" class="cont_sab">     
                                                            <tr><td align="center" colspan="2">S�bado</td></tr>
