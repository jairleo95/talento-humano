...
<html>
    <head>
        ...
        <title>Procesar Carga Acad�mica</title>
    ...
    <%
        int t = List_Autorizacion_Academico.size();
    %>
    ...
    <body onload='exito("Procesado con exito!", "Usted ha realizado una autorizaci�n correctamente.");' class="body">
        <%
            }
        } else {
        %>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            <tbody> 
                                                ...
                                                <!-- <tr><td colspan="9" align="center"><h3>No hay ning�n DGP por autorizar...</h3></td></tr>-->
                                                <%}%>
                                                <%for (int f = 0; f < List_Autorizacion_Academico.size(); f++) {

                                                        V_Autorizar_Dgp a = new V_Autorizar_Dgp();
                                                        a = (V_Autorizar_Dgp) List_Autorizacion_Academico.get(f);
                                                %>
                                            ...
                                            <% }
                                                ...
                                                List_Autorizacion_Academico.clear();%>
                                            </tbody>
                                        </table>
