...
function showEsDiezmo() {
    ...
    obj.empty();
    $.ajax({
        url: "trabajador/diezmo", data: "opc=ModDiezmoDetalleTrabajador&id=" + $(".idtr").val(), type: 'GET', success: function (data, textStatus, jqXHR) {
            if (data.rpta) {
                    ...
                    $.SmartMessageBox({
                        ...
                        if (ButtonPressed === "Si") {
                            if ($(".cbkDiezmo").prop("checked")) {
                                $.ajax({
                                    url: "trabajador/diezmo", data: "opc=UpdateEsDiezmo&id=" + $(".idtr").val() + "&estado=0", type: 'POST', success: function (data, textStatus, jqXHR) {
                                        if (data.status) {
                                ...
                                $.ajax({
                                    url: "trabajador/diezmo", data: "opc=UpdateEsDiezmo&id=" + $(".idtr").val() + "&estado=1", type: 'POST', success: function (data, textStatus, jqXHR) {
                                        if (data.status) {
...
function Listar_Cod_Huella() {
    ...
    $.ajax({
        url: "empleado", data: "opc=ShowHuella&idtr=" + $(".idtr").val(), type: 'GET', success: function (data, textStatus, jqXHR) {
...
function  ShowAFP_SP() {
    /*show  afp y sp*/
    $(".row_afp_sp").empty();
    $.ajax({url: "trabajador/afp", data: "opc=ShowAFP_SP&id=" + $(".idtr").val(), type: 'GET', success: function (data, textStatus, jqXHR) {
            if (data.rpta === "1") {
